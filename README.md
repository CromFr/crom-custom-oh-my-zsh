...
| Method    | Command                                                                                           |
|:----------|:--------------------------------------------------------------------------------------------------|
| **curl**  | `sh -c "$(curl -fsSL https://raw.githubusercontent.com/CromFr/crom-custom-oh-my-zsh/master/tools/install.sh)"` |
| **wget**  | `sh -c "$(wget -O- https://raw.githubusercontent.com/CromFr/crom-custom-oh-my-zsh/master/tools/install.sh)"`   |
| **fetch** | `sh -c "$(fetch -o - https://raw.githubusercontent.com/CromFr/crom-custom-oh-my-zsh/master/tools/install.sh)"` |
...
```shell
wget https://raw.githubusercontent.com/CromFr/crom-custom-oh-my-zsh/master/tools/install.sh
sh install.sh
```
...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/CromFr/crom-custom-oh-my-zsh/master/tools/install.sh)" "" --unattended
```
